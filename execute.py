    ...
    def download_all_file(self):
        ...
        try:
                        ...
                        if self.list_of_duplicate_byparts:
                            ...
                            for attachment_row in attachment_results:
                                ...
                                if file_type == "partseries":
                                    ...
                                    #print("partseries")
                                    #print(file_url)
                                    #print(local_directory_partseries)
           ...
           # print(self.m_list)
            ...
            print("removed is:",self.list_of_duplicate_byparts)
