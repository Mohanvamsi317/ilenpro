...
# function to know what files are downloadable format
    ...
    def download_all_file(self):
        ...
        #user defined input to make sure where the particular file needed to be stored in local
        ...
        try:
            ...
            for row in self.manufacture_results:
                ...
                #create the directory named as compilance inside the normalized_name
                    ...
                    if local_directory_blanket.exists():
                        ...
                        if (file_name.exists()):
                            ...
                            if (replace_choice == 'y' or replace_choice == 'yes'):
                                ...
                                logging.info("file has been overridden")
                                pbar.update(1)
                            if (replace_choice == "n" or replace_choice == "NO" or replace_choice == "N" or replace_choice == "no"):
            ...
            for k in self.list_of_duplicate_byparts:
                ...
                #removed all the duplicate bypart files that are mapped to multiple manufacturers 
                ...
                #print("self>list",self.list_of_duplicate_byparts)
                ...
                for i in self.list_of_duplicate_byparts:
                    ...
                    for j in ans:
                        ...
                        #files which are bypart and mapped to same manufacturer but mapped to different components  
                        for k in ans_in_j:
                            n_name = k[n]
